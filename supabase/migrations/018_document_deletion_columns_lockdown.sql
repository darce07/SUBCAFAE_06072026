...
-- Cierra un hueco encontrado en auditoría: fuera de las transiciones de baja
-- lógica / restauración (que ya validan eliminado_por/eliminado_at), un UPDATE
-- normal con permiso 'documentos:editar' podía fijar eliminado_por/eliminado_at
-- a cualquier valor arbitrario sin desactivar el documento, corrompiendo la
-- trazabilidad de quién/cuándo se eliminó.
