...
import { Bell, CheckCheck, DatabaseBackup, FileWarning, LoaderCircle, ReceiptText, ShieldAlert } from "lucide-react";
import { toast } from "sonner";
import { getNotifications, markAllNotificationsRead } from "../services/workspace.service";
import type { AppNotification } from "../types";
import { Alert, Badge, Button, Card, EmptyState, PageHeader } from "../components/ui";

const icons = { documental: FileWarning, financiero: ReceiptText, auditoria: ShieldAlert, seguridad: ShieldAlert, sistema: DatabaseBackup };
